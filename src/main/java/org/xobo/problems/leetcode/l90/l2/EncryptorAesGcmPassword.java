...
public class EncryptorAesGcmPassword {
  ...
  private static byte[] iv = CryptoUtils.getRandomNonce(IV_LENGTH_BYTE);
  private static byte[] salt = CryptoUtils.getRandomNonce(SALT_LENGTH_BYTE);
  ...
  public static void main(String[] args) throws Exception {
    ...
    System.out.println(encryptedTextBase642);
